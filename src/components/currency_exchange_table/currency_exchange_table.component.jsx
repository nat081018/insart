...
import getDateLocal from "../../redux/utilits"
import {connect} from "react-redux"
import { exchangeFetchInfoAction, exchangeFetchStartAction } from "../../redux/exchange/exchange.actions"
...
const  CurrencyExchangeTable = ({exchange,  exchangeFetchInfoAction, exchangeFetchStartAction}) => {
    console.log(exchange)
    // console.log(exchange.exchangeInfo)
    const [currentDate, setCurrentDate] = useState({date: ""})

    useEffect(() => {
        // setCurrentDate({date: getDateLocal(})
        exchangeFetchInfoAction()
    }, [exchangeFetchInfoAction])
    ...
    return (
            <div className="exchenge_table">
                <button onClick={exchangeFetchInfoAction}>click</button>
                <PopupForEdit/>
                <table>
                <caption>Currency exchange table</caption>
                    <tbody>
                        ...
                        {/* {
                            exchange.exchangeInfo.map(({base_ccy, ccy, buy, sale }, index) => ( 
                            <CurrencyExchange 
                            key={index}
                            base_ccy={base_ccy}
                            ccy={ccy}
...
const mapDispatchToProps = dispatch => ({
    exchangeFetchInfoAction:  () => dispatch(exchangeFetchInfoAction())
  });
...
// export default connect(mapStateToProps)(CurrencyExchangeTable)